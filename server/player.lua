...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.metadata['licences'] = PlayerData.metadata['licences'] or {
        ...
        ['business'] = false,
        ['weapon'] = false,
        ['hunting'] = false -- added by pamela for boii hunting
    }
...
function QBCore.Player.Save(source)
    ...
    if PlayerData then
        ...
        if GetResourceState('ps-inventory') ~= 'missing' then exports['qb-inventory']:SaveInventory(source) end
...
function QBCore.Player.SaveOffline(PlayerData)
    if PlayerData then
        ...
        if GetResourceState('ps-inventory') ~= 'missing' then exports['qb-inventory']:SaveInventory(PlayerData, true) end
